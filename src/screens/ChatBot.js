...
const ChatBot = ({navigation}) => {
    ...
    const [chatbot, setChatbot] = useState('hola') 


    useEffect(() => {
        const unsubscribe = navigation.addListener('focus', () => {
            // Cuando la pantalla está enfocada, ocultar el tab bar
    ...
    const handleChatBot = async () => {
      ...
      function extractErrorMessage(errorData) {
        if (errorData) {
          ...
          if (parts.length > 1) {
            ...
            return errorData;  // Devuelve el mensaje completo si no hay dos puntos
          }
        } else {
          return "No se proporcionó datos de error.";
        }
      }
      ...
      const newAnswer = {
        ...
        sender: "bot",
        message: extractErrorMessage(res.error.data),
        profileImage: "https://media.discordapp.net/attachments/1232163662488277017/1238137708291817595/image.png?ex=663e3119&is=663cdf99&hm=28a1c3aa41907b2e0d05536e50f881a040931f2f793ca3a7f5fa1309c841a987&=&format=webp&quality=lossless&width=556&height=531"
      };
